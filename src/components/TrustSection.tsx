...
const TrustSection = () => {
  ...
  return (
    <section className="section-luxury bg-secondary/20 py-12">
            ...
            return (
              <SwiperSlide key={index}>
                <motion.div
                  ...
                  className="flex flex-col items-center text-center bg-background/50 p-4 rounded-2xl shadow group mx-auto"
